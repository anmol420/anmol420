...
## Languages and Tools
<p align="center"> 
<img src="https://go-skill-icons.vercel.app/api/icons?i=express,js,mongodb,nodejs,npm,discordjs,git,github,react,tailwind,ts,nextjs,postman,gemini,markdown,postgres,vscode,docker,redis,prisma,hono,bun,arcjet,aws,flutter,dart,rabbitmq,java,spring,maven,springdatajpa,springsecurity,drizzle,go,dbeaver,socketio&perline=8&theme=dark" />
</p>
